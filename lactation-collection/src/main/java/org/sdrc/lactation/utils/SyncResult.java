...
public class SyncResult {
	...
	public void setFailureBFExpressions(
			List<FailureBFExpression> failureBFExpressions) {
	...
	public void setFailureFeedExpressions(
			List<FailureFeedExpression> failureFeedExpressions) {
