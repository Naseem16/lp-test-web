...
public class PatientModel {
	...
	public void setParentsKnowledgeOnHmAndLactation(
			int parentsKnowledgeOnHmAndLactation) {
	...
	public void setAdmissionDateForOutdoorPatients(
			String admissionDateForOutdoorPatients) {
